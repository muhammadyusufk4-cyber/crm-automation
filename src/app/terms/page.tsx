...
export const metadata: Metadata = {
  ...
  description: "Terms governing use of the SummitOps website and services.",
};
        ...
        <Container className="max-w-3xl">
          <div className="flex flex-col gap-8 text-foreground/70 leading-relaxed">
            <div>
              ...
              <p className="mt-3">
                This website is provided for informational purposes about SummitOps&apos;
            ...
            <div>
              ...
              <p className="mt-3">
                ...
                SummitOps unless otherwise noted, and may not be reproduced without written
                consent.
              </p>
            </div>
            <div>
              ...
              <p className="mt-3">
                SummitOps is not liable for any indirect or consequential damages arising from
